...
### Added (adaptación al proyecto real)
- Todo el repositorio adaptado del proyecto base "Horarios SENA" al proyecto real: Sistema de Gestión Supermercado "La Esquina", con base en el SRS v1.0
- `05-architecture/decisions/records/ADR-001-arquitectura-monolitica.md`: decisión de usar arquitectura monolítica (Flask + SQLite) en lugar de microservicios
- `07-api/contracts/openapi/supermercado-la-esquina.yaml`: contrato OpenAPI de la aplicación
- `08-uml/diagrams/source/`: diagramas de casos de uso, clases y secuencia del sistema
- Contenido real en las 16 secciones del repositorio (contexto, dominio, producto, requisitos, arquitectura, datos, API, UML, microservicios/monolito, devops, calidad, UX/UI, operaciones, entrenamiento y control de proyecto)
